...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 18, 2022 at 05:51 PM
...
CREATE TABLE `students` (
  ...
  `term_condition` enum('1','0') NOT NULL
...
INSERT INTO `students` (`id`, `image`, `first_name`, `last_name`, `email`, `mobile`, `country`, `state`, `city`, `address`, `term_condition`) VALUES
(1, '464115245(Mayank).jpg', 'Mayank', 'Salvi', 'mayanksalvi.8@gmail.com', '+917724918225', '101', '21', '2212', 'Kabir Pura Ward No. 01 Raghogarh', '1');
...
(1, 'Mayank Salvi', 'mayanksalvi.8@gmail.com', '202cb962ac59075b964b07152d234b70', '0');
